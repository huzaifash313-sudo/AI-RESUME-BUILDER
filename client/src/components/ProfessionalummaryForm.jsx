...
const ProfessionalummaryForm = ({data, onChange, setResumeData}) => {
    ...
    const generateSummary = async () => {
        try {
            ...
            // server returns { enhancedContent } inside data
    ...
    return (
        <div className='space-y-4'>
            ...
            <div className='mt-6'>
                ...
                />
                <p className='text-xs text-gray-500 max-w-2/4 mx-auto text-center'>
...
export default ProfessionalummaryForm
